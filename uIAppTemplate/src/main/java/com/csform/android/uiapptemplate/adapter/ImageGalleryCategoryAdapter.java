...
public class ImageGalleryCategoryAdapter extends BaseAdapter implements OnClickListener {
    ...
    public ImageGalleryCategoryAdapter(Context context, ArrayList<ImageGalleryCategoryModel> imageGalleryCategories, boolean isLayoutOnTop) {
        mContext = context;
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.list_item_image_1 || id == R.id.list_item_image_2) {
            ...
            intent.putParcelableArrayListExtra(ImageGallerySubcategoryActivity.IMAGE_GALLERY_SUBCATEGORY, mImageGalleryCategories.get(position).getSubcategories());
